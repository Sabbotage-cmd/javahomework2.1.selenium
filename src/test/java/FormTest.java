...
public class FormTest {
    ...
    private static String WebDriverPath = "C:\\Users\\Administrator\\";
    ...
    void shouldTestV2() {
        ...
        form.findElement(By.cssSelector("[data-test-id=name] input")).sendKeys("Владимир");
        form.findElement(By.cssSelector("[data-test-id=phone] input")).sendKeys("+79270000123");
    ...
    void testPositiveAllInput() {
        driver.get("http://localhost:9999");
        List<WebElement> elements = driver.findElements(By.className("input__control"));
        elements.get(0).sendKeys("Владимир Владимиров");
        elements.get(1).sendKeys("+79270000123");
        driver.findElement(By.className("checkbox__box")).click();
        driver.findElement(By.className("button")).click();
        String text = driver.findElement(By.cssSelector("[data-test-id=order-success]")).getText();
